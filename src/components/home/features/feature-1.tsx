      ...
      <div className="relative h-full w-full overflow-hidden">
        <div className="relative flex h-full w-full items-center justify-center">
          ...
          <div className="relative z-30 mx-auto grid w-full max-w-lg grid-cols-1 gap-4 p-8 [perspective:1000px] [transform-style:preserve-3d] sm:p-0 md:grid-cols-3">
            <div className="relative flex h-14 w-full flex-col items-start justify-center overflow-hidden rounded-lg bg-gradient-to-b from-white to-white p-2 px-2 font-mono text-neutral-800 shadow-lg dark:from-neutral-800 dark:to-neutral-700 dark:text-neutral-300 md:h-40">
            ...
            <div className="relative flex h-14 w-full items-center justify-center rounded-lg bg-gradient-to-b from-white to-white p-2 shadow-lg dark:from-neutral-800 dark:to-neutral-700 md:h-40">
              <svg
                width="800px"
                height="800px"
                viewBox="0 0 20 20"
            ...
            <div className="relative flex h-14 w-full flex-col items-center justify-center rounded-lg bg-gradient-to-b from-white to-white p-2 shadow-lg dark:from-neutral-800 dark:to-neutral-700 md:h-40">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 48 48"
                width="48px"
